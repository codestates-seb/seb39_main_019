...
`,g4=()=>{const{setUserId:e,setUserNickName:t,setUserEmail:n}=So(),[r,o]=I.exports.useState(""),[i,a]=I.exports.useState(""),u=I.exports.useRef(null),c=an();return I.exports.useEffect(()=>{u.current.focus()},[]),T("div",{children:[m(rl,{}),T(v4,{children:[m(y4,{children:m(je,{to:"/",children:m("span",{children:"Puppy Buddy"})})}),T(w4,{children:[m("h1",{children:"\uB85C\uADF8\uC778"}),T("form",{onSubmit:v=>{v.preventDefault(),Qe.defaults.withCredentials=!0,Qe.post("http://43.200.20.180:8080/auth/login",{email:r,password:i}).then(h=>{localStorage.setItem("refresh_token",h.data.refresh_token),sessionStorage.setItem("access_token",h.data.access_token),Xt({method:"get",url:"/api/me"}).then(C=>{t(C.nickname),n(C.email),e(C.memberId),C.memberCertificate==="DOG_OWNER"?c("/main"):c("/puppyauthentication")}).catch(C=>{console.log(C)})}).catch(h=>{console.log(h),bt.fire({icon:"error",text:"\uB85C\uADF8\uC778 \uC2E4\uD328!",width:"290px"})})},children:[T("div",{className:"group",children:[m("label",{htmlFor:"email",children:"\uC774\uBA54\uC77C"}),m("input",{type:"email",id:"email",ref:u,onChange:v=>o(v.target.value),required:!0})]}),T("div",{className:"group",children:[m("label",{htmlFor:"password",children:"\uBE44\uBC00\uBC88\uD638"}),m("input",{type:"password",id:"password",onChange:v=>a(v.target.value),required:!0,autoComplete:"off"})]}),m("div",{children:m(Gt,{text:"\uB85C\uADF8\uC778",type:"auth"})}),m(je,{to:"/signup",children:m(Gt,{text:"\uD68C\uC6D0\uAC00\uC785",type:"auth"})})]}),T("section",{children:[T("div",{className:"diveder",children:[m("hr",{}),m("span",{children:"OR"}),m("hr",{})]}),m("div",{className:"social_btn",children:m("button",{className:"kakaoBtn",onClick:()=>{bt.fire({icon:"info",text:"\uBBF8\uC644\uC131 \uAE30\uB2A5\uC785\uB2C8\uB2E4"})},children:m(f4,{})})})]})]})]})]})},v4=O.div`
  display: flex;
...
`,fS=()=>{const{location:e,personality:t,size:n,title:r,body:o,setBody:i,setTitle:a,url:u}=ul(),c=an();return m(Ao,{child:T(pS,{children:[m(mS,{children:T(hS,{children:[m(gS,{children:m(sS,{})}),m(vS,{children:m(cS,{})})]})}),m("button",{onClick:()=>Qe({url:"http://43.200.20.180:8080/v1/posts",method:"post",data:{title:r,personality:t,guName:e,size:n,content:o,imageId:[u]}}).then(()=>{c("/main"),i(""),a("")}).catch(p=>console.log(p)),className:"button",children:"\uB4F1\uB85D\uD558\uAE30"}),m("button",{className:"button",onClick:()=>c("/main"),children:"\uCDE8\uC18C"})]})})},pS=O.div`
  max-width: 1280px;
  margin: 0 auto;
  padding-top: 60px;
  text-align: center;
