...
public class JwtHelper {
    ...
    public static String generateAccessToken(Long memberId, MemberRole role) {
        ...
        return Jwts.builder()
                .setClaims(claims)
                .setSubject(memberId.toString()) //이 토큰을 발급받는 사용자
                .setIssuedAt(new Date(System.currentTimeMillis())) //발행날짜
                .setExpiration(new Date(System.currentTimeMillis() + ACCESS_TOKEN_VALIDITY)) //만료시킬 날짜
